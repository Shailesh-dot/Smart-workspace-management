    ...
    <div className="max-w-5xl mx-auto">
      ...
      <div className="grid lg:grid-cols-4 gap-8">
            ...
            <button
              ...
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all ${
                activeSection === section.id
                  ? (globalTheme === "dark" ? "bg-zinc-900 text-accent border border-zinc-800 font-bold" : "bg-sky-50 text-sky-600 border border-sky-100 font-bold")
                  : "text-zinc-500 hover:text-sky-600 hover:bg-sky-50/50"
              }`}
            >
        ...
        <div className={`lg:col-span-3 border rounded-3xl p-8 shadow-sm transition-all duration-300 relative ${
          globalTheme === "dark" ? "bg-zinc-900 border-zinc-800" : "bg-white border-sky-100"
        }`}>
          {/* Notification Toast */}
          {notification && (
